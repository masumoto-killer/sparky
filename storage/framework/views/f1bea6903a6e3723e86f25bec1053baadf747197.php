            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/order')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">HOME</a>
                    <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\sparky\resources\views/welcome.blade.php ENDPATH**/ ?>